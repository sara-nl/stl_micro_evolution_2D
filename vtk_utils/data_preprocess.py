...
def main(args):
    ...
    dataset_2D, dataset_3D = generate_datasets(
        sample_list, output_path, output_name, slicing=False
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--tar_path",
        type=str,
        default="/projects/1/monicar/test.tar.gz",  # exp_1.tar.gz
    )
    parser.add_argument("--output_path", type=str, default="/projects/1/monicar")
    parser.add_argument("--output_name", type=str, default="trial")
